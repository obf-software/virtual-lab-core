DO $$ BEGIN
 CREATE TYPE "instance_connection_type" AS ENUM('VNC', 'RDP');
EXCEPTION
...
CREATE TABLE IF NOT EXISTS "instance" (
	...
	"provision_token" varchar(50) NOT NULL,
	"name" varchar(128) NOT NULL,
	"description" text NOT NULL,
	...
	CONSTRAINT "instance_provision_token_unique" UNIQUE("provision_token")
);
--> statement-breakpoint
